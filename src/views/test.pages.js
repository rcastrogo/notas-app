  ...
  function mergeData(data) {
    ...
    utils.addEventListeners(itemsContainer, {}, {
      ...
      showImage: function (libro) {
        ctx.router.navigateTo('images/{0}'.format(data[libro.tag].ID));
      }
...
let imagePage = function (ctx) {
  ...
  <div class="w3-bar w3-black">
    <button on-click="goBack" class="w3-button w3-black"><i class="fa fa fa-chevron-left"></i></button>Imagen
  </div>
  <div class="w3-animate-left" on-click="notify" style="lightgray url() center center no-repeat;position:absolute;top:38px;bottom:0;left:0;right:0;">
  </div>`;
  ...
  let component = {
    ...
    dispose : function(){
      ...
      pol.$('appMenu').style.display = '';
    
      let style = pol.$('app-content-container').style;
      style.position ='';
  ...
  function initAll(container) {
    ...
    pol.$('appMenu').style.display = 'none';
    pol.$('appMenu').classList.remove('sticky');
